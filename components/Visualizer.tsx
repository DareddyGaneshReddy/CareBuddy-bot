      ...
      <div className="absolute -bottom-12 flex flex-col items-center gap-2">
        {isThinking && (
          <div className="flex items-center gap-2 animate-pulse">
            <span className="text-[10px] uppercase tracking-[0.4em] font-black text-amber-500">Thinking...</span>
          </div>
        )}
        {active && !isSpeaking && !isThinking && (
          <span className="text-[8px] uppercase tracking-[0.5em] font-bold text-slate-500 opacity-50">Listening...</span>
        )}
      </div>
